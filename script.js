  window.tailwind.config = { darkMode: 'class', theme: { screens: { 'sm': '885px', 'md': '1024px', 'lg': '1280px', 'xl': '1536px' }, extend: { colors: { primary: '#10b981', accent: '#fbbf24', darkBg: '#020617' }, fontFamily: { cairo: ['Cairo', 'sans-serif'], amiri: ['Amiri', 'serif'] } } } };
    ...
    function holyApp() {
        return {
            ...
            quickStats: [ { id: 'favs', label: 'المفضلة', value: 0, icon: 'fa-solid fa-heart', bg: 'bg-red-500' }, { id: 'surahs', label: 'السور', value: 114, icon: 'fa-solid fa-book', bg: 'bg-primary' }, { id: 'athkar', label: 'الأذكار', value: '4', icon: 'fa-solid fa-hands-praying', bg: 'bg-accent' }, { id: 'reciter', label: 'القارئ', value: '', icon: 'fa-solid fa-microphone', bg: 'bg-blue-500' } ],
